...
* **Call Statement**    
    A call statement consists of an operation or function call returning `Unit`. The invoked callable needs to satisfy the requirements imposed by the current context. See [this section](xref:microsoft.quantum.qsharp.callstatements#call-statements) for more details.
